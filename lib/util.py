...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-dvc")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-dvc")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-dvc")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-dvc/"
    else:
...
def appdata_dir():
    """Find the path to the application data directory; add an electrum-dvc folder and return path."""
    if platform.system() == "Windows":
        return os.path.join(os.environ["APPDATA"], "Electrum-dvc")
    elif platform.system() == "Linux":
        return os.path.join(sys.prefix, "share", "electrum-dvc")
    elif (platform.system() == "Darwin" or
          platform.system() == "DragonFly" or
          platform.system() == "OpenBSD" or
          platform.system() == "FreeBSD" or
	  platform.system() == "NetBSD"):
        return "/Library/Application Support/Electrum-dvc"
    else:
